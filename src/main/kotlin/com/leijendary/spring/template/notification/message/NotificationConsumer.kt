...
class NotificationConsumer(
    ...
    @KafkaListener(topics = ["\${spring.kafka.topic.${NOTIFICATION_EMAIL}}"])
    ...
    @KafkaListener(topics = ["\${spring.kafka.topic.$NOTIFICATION_PUSH}"])
    ...
    @KafkaListener(topics = ["\${spring.kafka.topic.${NOTIFICATION_SMS}}"])
    fun sms(json: String) {
