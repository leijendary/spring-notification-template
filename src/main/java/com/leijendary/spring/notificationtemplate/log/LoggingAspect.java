package com.leijendary.spring.notificationtemplate.log;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.leijendary.spring.notificationtemplate..*.*(..))")
    public void includedPointcut() {}

    @Pointcut(
            "execution(* com.leijendary.spring.notificationtemplate.config..*.*(..)) || " +
            "execution(* com.leijendary.spring.notificationtemplate.filter..*.*(..)) || " +
            "execution(* com.leijendary.spring.notificationtemplate.log..*.*(..)) || " +
            "execution(* com.leijendary.spring.notificationtemplate.Application..*(..))")
