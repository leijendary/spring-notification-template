...
import com.leijendary.spring.notificationtemplate.util.JsonUtil;
...
public class SampleControllerV1Test extends ApplicationTests {
    ...
    public void list_HasContent_Success() {
        ...
        final var data = JsonUtil.toClass(dataResponse.getData(), List.class);
    ...
    public void get_Existing_Success() {
        ...
        final var sampleResponse = JsonUtil.toClass(dataResponse.getData(), SampleResponseV1.class);
