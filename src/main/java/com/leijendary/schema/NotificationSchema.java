...
public class NotificationSchema extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<NotificationSchema> ENCODER =
      new BinaryMessageEncoder<NotificationSchema>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<NotificationSchema> DECODER =
      new BinaryMessageDecoder<NotificationSchema>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<NotificationSchema> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<NotificationSchema> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<NotificationSchema> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<NotificationSchema>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this NotificationSchema to a ByteBuffer.
  ...
  /**
   * Deserializes a NotificationSchema from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a NotificationSchema instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static NotificationSchema fromByteBuffer(
   ...
   */
  public NotificationSchema(java.lang.String to, java.lang.String content, java.lang.String name, java.lang.String type) {
    this.to = to;
  ...
  /**
   * Creates a new NotificationSchema RecordBuilder by copying an existing Builder.
  ...
  /**
   * Creates a new NotificationSchema RecordBuilder by copying an existing NotificationSchema instance.
  ...
  /**
   * RecordBuilder for NotificationSchema instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<NotificationSchema>
    implements org.apache.avro.data.RecordBuilder<NotificationSchema> {
    ...
    public NotificationSchema build() {
      try {
        NotificationSchema record = new NotificationSchema();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<NotificationSchema>
    WRITER$ = (org.apache.avro.io.DatumWriter<NotificationSchema>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<NotificationSchema>
    READER$ = (org.apache.avro.io.DatumReader<NotificationSchema>)MODEL$.createDatumReader(SCHEMA$);
